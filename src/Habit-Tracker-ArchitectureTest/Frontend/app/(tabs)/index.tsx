...
import axios from 'axios'; //HTTP Client für Kommunikation zwischen Front und Backend
import {
  Pressable,
  ScrollView,
  StyleSheet,
...
export default function HomeScreen() {
  const API_URL = 'http://BackendAdress:Port/Route'; // ggf. IP anpassen
  ...
  const fetchHabits = async () => {
    try {
      const response = await axios.get<{ id: number; name: string }[]>(API_URL);
