...
- **Warum sehe ich den QR-Code nicht?** → Stelle sicher, dass Expo läuft und dein Handy im gleichen Netzwerk ist.

- **Meine Habits verschwinden nach einem Update?** → Prüfe, ob du dich mit deinem Account eingeloggt hast.
