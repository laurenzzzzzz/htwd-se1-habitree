...
*Performance: Geringe Latenz bei UI-Interaktionen.
*Zuverlässigkeit: Redundante Services, automatisches Roll-Back und Health-Checks.
*Sicherheit: Authentifizierung, Verschlüsselung Daten.
*Portabilität: Gemeinsame Code-Basis für Android & iOS über Expo
*Echtzeit-Updates
*Offline-Support

== Annahmen und Abhängigkeiten
//[List the assumptions and dependencies that drive architectural decisions. This could include sensitive or critical areas, dependencies on legacy interfaces, the skill and experience of the team, the availability of important resources, and so forth]
*Infrastruktur: Eigener Server im Rechenzentrum
*Datenbanken
