...
Es ist möglich die App im Browser zu benutzen, wird aber nicht unterstützt.
...
Da der Server immer online ist, wird mir Ausfallzeiten erstmal nicht gerechnet. Für Wartungen des Servers, auf dem der Datenbankserver läuft, gewartet wird können geringe Ausfallzeiten entstehen. 
