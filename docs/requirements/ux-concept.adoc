...
*Nutzer: Hannes Krusch* _“Ich will nicht mehr, ich kann nicht mehr, ich halt das alles nicht mehr aus”_
...
|Demografie
|20 Jahre alt, männlich, Student, ledig, wohnhaft in Dresden

|Verhaltensvariablen
|eher extrovertiert, trotz vorhandener Motivation Schwierigkeiten, Routinen dauerhaft und beständig beizubehalten
