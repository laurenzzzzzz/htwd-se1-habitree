...
In unserem Team  hat Inklusion einen hohen Stellenwert. Demnach achten wir sehr genau darauf, dass unsere App von möglichst vielen Nutzern unabhängig potenzieller Behinderungen und Barrieren nutzbar ist.  Laut dem statistischen Bundesamt leiden derzeit rund 9.4% aller deutschen Bürgen an Einschränkungen. Diese untergliedern sich abermals wie folgt:  +
- körperlich bedingte Behinderungen: 4,5 Millionen Menschen  +
- seelisch/ geistig bedingte Behinderungen: 1.8 Millionen Menschen  +
- weitere Behinderungen ohne Spezifizierung: 1.5 Millionen Menschen  +
...
Wir verpflichten  uns diese mit  umzusetzen bei der Abarbeitung aller Task von den User Stories und sind somit Voraussetzungen bevor eine User Story auf "done" gesetzt werden kann. Demnach probieren wir maximale Usability und Barrerefreiheit in unser Programm mit einzubringen, auch wenn wir uns darüber bewusst sind, dass wir nicht alle Menschen mit allen möglichen Einschränkungen inkludieren können. Grenzen liegen derzeit zum Beispiel bei einer Steuerung des Programmes via Spracherkennung oder nur über Gesten.
