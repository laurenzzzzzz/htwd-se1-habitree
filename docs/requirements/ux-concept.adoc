...
|Technische Fähigkeiten | ist viel am PC bzw. Handy, hat hohe technische Kompetenzen
...
|Technische Fähigkeiten | benutzt häufig ihr Tablet und Handy, wenig Kompetenzen am PC
