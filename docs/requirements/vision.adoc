...
| xx
| Die Anwendung soll auf allen Geräten intuitiv bedienbar sein und auch Menschen mit besonderen Bedürfnissen (z. B. ADHS) gerecht werden.
| xx
...
| Reaktionszeit des Systemes  +
- Das system sollte innerhalb von maximal 30 ms Antworten generieren| Mittel | xx 
| Sicherheit  +
