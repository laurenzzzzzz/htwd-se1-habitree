...
Dieses Visions-Dokument bezieht sich auf das System {project-system-name}, das von Team 3A entwickelt wird. Das System wird es vorallem Studenten erlauben, tägliche Gewohnheiten zu verfolgen um Routinen zu entwickeln um gewünschtes Verhalten anzutrainieren oder schlechtes Verhalten abzulegen. Ziel ist es dem Nutzer bei seiner gewünschten persönlichen Weiterentwicklung zu unterstützen.
