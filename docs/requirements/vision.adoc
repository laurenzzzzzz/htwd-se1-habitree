...
| Personen im Berufsleben mit festem oder flexiblem Arbeitsalltag, die Struktur in ihren Tagesablauf bringen und gesunde Routinen integrieren möchten.
| Sie wünschen sich eine alltagstaugliche Lösung zur Gewohnheitsbildung, die mit Arbeitszeiten kompatibel ist. Sie legen Wert auf Effizienz, Klarheit, Datenschutz und mobile Verfügbarkeit.
Ihr Feedback hilft dabei, das System auch außerhalb des Studierendenkontexts praxistauglich zu gestalten.
| Projektgruppe
