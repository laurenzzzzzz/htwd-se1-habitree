...
| Professor Dr. Ing. Jürgen Anke, Dipl. Inf. (FH) Christoph Zirkelbach
| Projektauftraggeber, Coaches
| Stellen die Aufgabenstellung zum Projekt, stehen für Fragen zum Projekt zur verfügung, bewerten das Projekt, 
|===
