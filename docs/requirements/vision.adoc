...
| Diese Institutionen achten darauf, dass personenbezogene Daten korrekt verarbeitet werden, nach aktuellen gesetzlichen Bestimmungen (wie z.B.: der DSGVO) . Ferner beurteilen Sie auch die Einhaltung des Urheberrechtes bei Verwendung von beispielsweisen externen Grafiken. (z.B.: mittels UrhG) oder auch die Einhaltung der Standards des Bundesamt für Sicherheit in der Informationstechnik.
