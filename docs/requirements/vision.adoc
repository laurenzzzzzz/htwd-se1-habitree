...
[cols="1,3"]
|===
| Für | Junge Erwachsene, vor allem Berufstätige und Studierende mit dem Wunsch nach persönlicher Weiterentwicklung
...
| Anders als | herkömmliche Kalender- oder Notiz-Apps mit einfachen Erinnerungen und Dokumentationsfunktionen oder klassische Tagebücher
