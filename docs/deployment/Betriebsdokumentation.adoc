...
== Systemvoraussetzungen für Backend
...
* alle gängigen Betriebssysteme mit Docker-Unterstützung (Linux, Windows 10/11, macOS)
...
|Node.js |20 LTS |Laufzeitumgebung Backend (läuft in Container)
|===
